...
username_button = tk.Button(top_frame, text="Join", font=BUTTON_FONT, bg=DARK_GREY, fg=WHITE, command=connect)
username_button.pack(side=tk.LEFT, padx=15)

message_textbox = tk.Entry(bottom_frame, font=FONT, bg=DARK_GREY, fg=WHITE, width=38)
message_textbox.pack(side=tk.LEFT, padx=10)

message_button = tk.Button(bottom_frame, text="Send", font=BUTTON_FONT, bg=DARK_GREY, fg=WHITE, command=send_message)
